    ...
    <body>
        ...
        <div class="w3-container">     
            <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
                <h2 class="w3-center w3-large w3-gray w3-hide-small">ACCESO AL SISTEMA PARA MAESTROS</h2>
                <h2 class="w3-center w3-small w3-gray w3-hide-medium w3-hide-large"><b>ACCESO AL SISTEMA PARA MAESTROS</b></h2>
                @if( Session::get('fail'))<div class="w3-center w3-red">{{ Session::get('fail') }}</div>@endif
                <form class="w3-container" action="{{ route('maestros.check')}}" method="post">
                    @csrf
                    <div class="w3-section">
                        <input class="w3-input w3-border w3-margin-bottom" type="text" name="idpersonas" placeholder="Usuario" autofocus required>
                    ...
                    <div class="w3-container w3-border-top w3-padding w3-light-grey w3-center">
                        ...
                        <a href="/maestros/salir_m" ><button class="w3-button w3-red " type="button" >SALIR</button></a>
                    </div>
                </form>
                <br>
            </div>
